...
namespace FastBookCreator.Controllers
{
    public class TestController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                connection.Open();
                connection.Execute(@"CREATE TABLE Pack (PackId integer primary key autoincrement not null, PackName Text not null, Description Text null) ");
                connection.Execute(@"insert #t (Name,Age) values(@Name, @Age)", new List<Pack>
                {
                    new Pack{Description = "", PackName= "sam"}
                });
